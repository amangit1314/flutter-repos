...
class EntryProvider extends ChangeNotifier {
  ...
  static const String _databaseId = "user_movies";
  Entry? _selected;
  ...
  Future<void> list() async {
    var result = await ApiClient.database
        .listDocuments(collectionId: _collectionId, databaseId: _databaseId);
  ...
  Future<Uint8List> imageFor(Entry entry) async {
    ...
    final result = await ApiClient.storage
        .getFileView(fileId: entry.thumbnailImageId, bucketId: '');
