...
import '../../core/providers/entry.dart';
import '../../core/providers/watchlist.dart';
import '../../core/widgets/buttons/icon.dart';
import '../../data/models/entry.dart';

class DetailsScreen extends StatefulWidget {
  final Entry _entry;

  const DetailsScreen({Key? key, required Entry entry})
      : _entry = entry,
        super(key: key);
    ...
    return Scaffold(
      ...
      children: [
        ...
        Expanded(
            child: Padding(
          padding: const EdgeInsets.fromLTRB(20, 0, 20, 0),
          child: Text("Starring: ${widget._entry.cast}",
